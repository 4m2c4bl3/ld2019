...
function create() {
  ...
  frontScenery.create(28, 910, "house").setDepth(6);

  //create classes

  this.player = new Player(this, spawnPoint.x, spawnPoint.y);
  this.physics.add.collider(this.player.aura, baseLayer);
  this.traps = new Traps({scene: this, map: map, player: this.player, callback: fadeSceneRestart})
  ...
  //add physics
  // this.physics.add.overlap(this.player.aura, escapeTrigger, () => {console.log('escaped'); return true;});

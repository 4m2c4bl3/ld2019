...
export default class Timer {
    constructor({ input, time, callback, parent }) {
        ...
        this.input.keyboard.on('keydown-SPACE', () => this.timer.paused = false);
    ...
    update() {
        this.timer.paused = true;
        const timerBasedAlpha = ((Math.ceil(this.timer.elapsed / 1000) * 15).toFixed(3) / 100) - 0.3;
        this.overlay.setAlpha(this.overrideAlpha || timerBasedAlpha);
